...
const server = http.createServer(function (request, response) {
    ...
    if(request.method === "GET"){
        ...
        }else if (request.url === "/styles.80f2d8e9e393f3581758.css"){
            fs.readFile("styles.80f2d8e9e393f3581758.css", function(err, data){
                if(err){
                    console.log("hello");
					response.statusCode = 500;
					response.write("Server error.");
        ...
        }else if (request.url === "/runtime.e227d1a0e31cbccbf8ec.js"){
            fs.readFile("runtime.e227d1a0e31cbccbf8ec.js", function(err, data){
                if(err){
                    console.log("hello");
					response.statusCode = 500;
					response.write("Server error.");
        ...
        }else if (request.url === "/polyfills.a4021de53358bb0fec14.js"){
            fs.readFile("polyfills.a4021de53358bb0fec14.js", function(err, data){
                if(err){
                    console.log("hello");
					response.statusCode = 500;
					response.write("Server error.");
        ...
        }else if (request.url === "/main.84de5b812c1cce58853c.js"){
            fs.readFile("main.84de5b812c1cce58853c.js", function(err, data){
                if(err){
                    console.log("hello");
					response.statusCode = 500;
					response.write("Server error.");
        ...
        }else if(request.url.startsWith("/api/getProfile") ){
